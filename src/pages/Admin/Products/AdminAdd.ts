                ...
                <div class="grid grid-cols-3 gap-8">
                    <div>
                        <div class="flex flex-col justify-center items-center border rounded-md h-[250px]" style="position: relative">
                            ...
                            <img id="preview-image" style="position: absolute; height: 250px"/>
                        </div>
                        <div class="mt-3">
                            <label for="">Mô tả ngắn</label>
                            <textarea id="shortDescription" class="w-full border"></textarea>
                        </div>
                    </div>
                    <div class="col-span-2">
                        ...
                        <div class="flex flex-col mt-4">
                            ...
                            <textarea id="feature" class="w-full border"></textarea>
                        </div>
                        <div class="flex flex-col mt-4">
                            <label for="">Mô tả dài</label>
                            <textarea id="description" class="w-full border"></textarea>
                        </div>
